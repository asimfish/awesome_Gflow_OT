...
\begin{column}{0.235\textwidth}\begin{block}{18 篇保版式中译 PDF}\footnotesize SuperTranslate：公式/图表/引用冻结，正文按原坐标回填；每篇附对象级 QA（inspect.json）。O01 讲义 480 页用 Gemini 2.5 Flash 后端单独翻译\end{block}\end{column}
